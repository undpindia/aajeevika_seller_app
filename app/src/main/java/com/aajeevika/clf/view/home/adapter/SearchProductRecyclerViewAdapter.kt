...
import com.aajeevika.clf.model.data_model.SearchProductData
...
class SearchProductRecyclerViewAdapter(private val requestData: (Int) -> Unit) : BaseRecyclerViewAdapter() {
    private val dataList = ArrayList<SearchProductData>()
    private var isNextPageRequested = false
    private var currentPage: Int = -1
    private var lastPage: Int = -1

    fun addData(data: ArrayList<SearchProductData>, currentPage: Int, lastPage: Int) {
